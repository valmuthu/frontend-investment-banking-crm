            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                  {networkingStatuses && networkingStatuses.map(status => (
              ...
              <div>
                ...
                >
                  ...
                  {nextStepsOptions && nextStepsOptions.map(step => (
          ...
          <div className="mt-6 space-y-4">
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <label htmlFor="referred-edit" className="ml-2 text-sm font-medium text-gray-700">
                This is a referred contact
              </label>
            </div>
...
// Interview Modal (simplified for now)
...
// Edit Interview Modal (simplified for now)
